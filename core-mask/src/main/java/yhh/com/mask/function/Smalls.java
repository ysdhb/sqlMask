...
//        assertThat(RexLiteral.validConstant(p, Litmus.THROW), is(true));
    ...
    public static class MyConcate2 {
        public String eval(@Parameter(name = "a") String a, @Parameter(name = "b") String b, @Parameter(name = "c") String c) {
            return a + b + c;
        }
    }

    public static class MyConcate3 {
        public String eval(@Parameter(name = "a") String[] a) {
            return a[0];
        }
    }
    ...
    public static class MyConcate {
        public String eval(@Parameter(name = "s") String s,
                           @Parameter(name = "n") String n) {
            return s + n;
